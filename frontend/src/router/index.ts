...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
        ...
        children: [
          {
            path: "process-output",
            name: "process-output",
            component: () => import("@/views/account/AccountClis.vue"),
            meta: {
              pageTitle: "Process output",
            },
            props: true,
          },

          {
            path: "messages",
            name: "messages",
            component: () => import("@/views/account/AccountMessages.vue"),
            meta: {
              pageTitle: "Messages",
            },
            props: true,
      ...
      },
      {
        path: "/looms",
        name: "looms",
        component: () => import("@/views/loom/Looms.vue"),
        meta: {
          pageTitle: "Looms",
          breadcrumbs: ["Looms"],
        },
...

      {
        ...
        //         path: "process-output",
        //         name: "process-output",
        //         component: () => import("@/views/lead/AccountClis.vue"),
        //         meta: {
        //             pageTitle: "Process output",
        //         },
        //         props:true
