  ...
  <div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    <div
      ...
      >
        ...
        <!--begin::Image-->
        <img
          class="d-none d-lg-block mx-auto w-275px w-md-50 w-xl-350px mt-30 mb-lg-20"
          src="/media/misc/2.webp"
        ...
        <div class="d-none d-lg-block text-white fs-base text-center">
          ...
          <a href="#" class="opacity-75-hover text-warning fw-bold me-1"
            >Instagram automation</a
          >

          tool designed for seamless direct messaging and <br />
          effective follow-ups. Streamline your interactions,

          <a href="#" class="opacity-75-hover text-warning fw-bold me-1"
            >increase engagement</a>
          and watch your  <br />
          productivity soar as our app handles the heavy lifting, allowing you to focus on what truly matters—building connections and growing your presence.
        </div>
        <!--end::Text-->
      </div>
      <!--end::Content-->
