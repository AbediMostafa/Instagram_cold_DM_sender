        ...
        <template v-for="(item, i) in MainMenuConfig" :key="i">
          ...
          <template v-for="(menuItem, j) in item.pages" :key="j">
            <template v-if="menuItem.heading">
              <div class="menu-item" v-has-any-of-these-roles="menuItem.allowed_roles">
                <router-link
                    v-if="menuItem.route"
                    class="menu-link"
                    active-class="active"
            ...
            <div
                v-has-any-of-these-roles="menuItem.allowed_roles"
            ...
            >
              ...
              >
                <template v-for="(item2, k) in menuItem.sub" :key="k">
                  <div v-if="item2.heading" class="menu-item" v-has-any-of-these-roles="menuItem.allowed_roles">
                    <router-link
                        v-if="item2.route"
                        class="menu-link"
                        active-class="active"
