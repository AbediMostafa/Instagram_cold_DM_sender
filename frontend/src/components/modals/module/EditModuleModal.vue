          ...
          >
            ...
            <div class="text-center">
              <button
                  ...
                  @click="hideModal('edit_module_modal')"
              >
                Cancel
              </button>
  ...
  setup(props) {
    ...
    watch(
        ...
        (newVal) => {
          ...
          formData.value.module_path = newVal.module_path;
          formData.value.class_name = newVal.class_name;
          formData.value.workflow_id = newVal.workflow_id;
          formData.value.priority = newVal.priority;
        },
        {immediate: true}
    );
    ...
    const submit = () => {
      ...
      formRef.value.validate((valid: boolean) => {
        ...
        ApiService.post("modules/update", formData.value)
            .then(() => {
              hideModal("edit_module_modal");
