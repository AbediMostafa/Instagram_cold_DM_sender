...
from .BrowserPostImageFromFolderEvent import BrowserPostImageFromFolderEvent
import traceback


class PostImageFromFolderContext(InstagramMiddleware):
    ig = None
    strategies = []
    ...
    def execute(self):
        try:
            ...
            BrowserPostImageFromFolderEvent(self.ig).init()
